...
const SignUp = (props) => {
  return (
    <div className="p-20 bg-gradient-to-r from-pink-500 from-10% via-red-500 via-40% to-black to-70%">
      <Row gutter={[8, 60]}>
        <Col span={24}>
        ...
        <Col span={24}>
          <div className="flex flex-col md:flex-row justify-between">
            <Text className="text-white order-last md:order-first text-center md:text-start md:self-end mt-4 md:mt-0 cursor-pointer">
              Stay connected
            </Text>
